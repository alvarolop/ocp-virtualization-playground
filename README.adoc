...
oc process -f virt-vms/02-vm-fedora.yaml -p VM_NAME=fedora-03-b -p IP_ADDRESS="192.168.51.151/24" | oc apply -f -
----
...
[source, bash]
----
oc process -f virt-vms/04-vm-fedora.yaml -p VM_NAME=fedora-04 -p IP_ADDRESS="192.168.51.153/24" | oc apply -f -
----
