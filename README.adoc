...
In some cases, networking configuration could be tricky. In this link:analysis-network-config/RESULTS.adoc[section], I compare several VM configuration combinations and its real configuration in the machine.
