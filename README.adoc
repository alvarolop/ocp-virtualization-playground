...
{yes}ConfigMap
| {yes}DataVolume
|link:ocp-virtualization/11-vm-fedora-04.yaml[Click here]
...
[source, bash]
----
oc process -f ocp-virtualization/11-vm-fedora-03.yaml -p VM_NAME=fedora-04 -p IP_ADDRESS="192.168.51.152/24" | oc apply -f -
----
...
[source, bash]
----
oc process -f ocp-virtualization/11-vm-fedora-04.yaml -p VM_NAME=fedora-05 -p IP_ADDRESS="192.168.51.153/24" | oc apply -f -
----
